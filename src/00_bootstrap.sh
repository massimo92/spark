...
WORKSPACE_SUPER_PRODUCTIVITY_GATEWAY_CONFIG="${WORKSPACE_CONFIG_DIR}/super-productivity-gateway.conf"
...
WORKSPACE_SUPER_PRODUCTIVITY_CONTAINER="workspace-super-productivity"
...
WORKSPACE_SUPER_PRODUCTIVITY_GATEWAY_CONTAINER="workspace-super-productivity-gateway"
...
WORKSPACE_SUPER_PRODUCTIVITY_IMAGE_DEFAULT="super-productivity/super-productivity:latest"
WORKSPACE_SUPERSYNC_IMAGE_DEFAULT="ghcr.io/super-productivity/supersync:latest"
WORKSPACE_SUPER_PRODUCTIVITY_GATEWAY_IMAGE_DEFAULT="nginx:1.29-alpine"
